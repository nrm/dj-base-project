...
DATABASES = {
    'default': {
        ...
        'NAME': '%s/../db/project_db.sql'%PROJECT_ROOT,                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'example/static'),
)
...
SECRET_KEY = ')tot5l=7!qml4vs@ocn$m_@%^@2!fze61zljvd$9!0g7!&90%3'
